...
public class LoginSistema extends JFrame {
	...
	public LoginSistema() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(LoginSistema.class.getResource("/imagenes/aH-40px.png")));
		setResizable(false);
		setUndecorated(true);
		...
		imgHotel.setIcon(new ImageIcon(LoginSistema.class.getResource("/imagenes/img-hotel-login-.png")));
		...
		lblNewLabel_1.setIcon(new ImageIcon(LoginSistema.class.getResource("/imagenes/lOGO-50PX.png")));
