...
public class LoginModificarReserva extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					LoginModificarReserva frame = new LoginModificarReserva();
	 ...
	 * Create the frame.
	 */
	public LoginModificarReserva() {

		this.loginController = new LoginController();
		setIconImage(Toolkit.getDefaultToolkit().getImage(LoginModificarReserva.class.getResource("/imagenes/aH-40px.png")));
		setResizable(false);
		setUndecorated(true);
		...
		//UIManager.put("TextField.foreground", new Color(12, 138, 199));
		...
		lblImagen.setIcon(new ImageIcon(LoginModificarReserva.class.getResource("/imagenes/login.png")));
	...
	private void Login() {
		...
		if (acceso > 2) {
			EditarReservas editar = new EditarReservas();
