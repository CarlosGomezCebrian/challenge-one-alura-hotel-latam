...
public class LoginEliminarHuesped extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					LoginEliminarHuesped frame = new LoginEliminarHuesped();
	 ...
	 * Create the frame.
	 */
	public LoginEliminarHuesped() {
		
		this.loginController = new LoginController();
		setIconImage(Toolkit.getDefaultToolkit().getImage(LoginEliminarHuesped.class.getResource("/imagenes/aH-40px.png")));
		setResizable(false);
		setUndecorated(true);
		...
		lblImagen.setIcon(new ImageIcon(LoginEliminarHuesped.class.getResource("/imagenes/login.png")));
	...
	private void Login() {
		...
		if (acceso > 3) {
			EliminarHuesped eliminar = new EliminarHuesped();
